<?php
// Endpoint: Registra la hora de salida de un recepcionista en la tabla 'fichajes'.
...
// Inserta el fichaje de salida con la fecha y hora actual
$sql = "INSERT INTO fichajes (recepcionista_id, tipo, fecha_hora) VALUES (?, 'salida', NOW())";
